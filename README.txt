# Phase 4 - Building A Restaurant Website With Bootstrap -- HCL ASSESSMENT
...
## Steps
1. Open live server in VSCode
2. Go to the correct localhost port to view the application.
